        ...
        <div class="prod-info-fly">
          ...
          <div class="price">
            ...
            <div class="count_holder_small">
              ...
              <div id="UniversumCountSmallSpecial<?php echo $product['product_id']; ?>"></div>
              <script type="text/javascript">
					$(function () {	
						$('#UniversumCountSmallSpecial<?php echo $product['product_id']; ?>').countdown({until: new Date(<?php echo $product['date_end']; ?>), compact: false});
					});
		</script>
              <div class="clear"></div>
              <?php } ?>
