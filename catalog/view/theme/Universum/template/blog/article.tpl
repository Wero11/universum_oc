...
<h1 itemprop="headline" class="heading_title"><?php echo $title; ?></h1>
</div>
</div>
         ...
         <div class="articleBottom">
            ...
            <?php if ($artRelateds) { ?>
               <div id="articleRelated">
                  <h2 class="heading_title"><span><?php echo $text_related; ?></span></h2>
            ...
            <?php if ($prodRelateds && $relProductRelated) { ?>
               <div id="productRelated">
                  <h2 class="heading_title"><span><?php echo $text_related_product; ?></span></h2>
                  ...
                  <?php foreach ($prodRelateds as $prodRelated) { ?>
                     <div class="relProduct" style="width:<?php echo (100/$prodPerRow)-0.5 . '%';?>">
                        ...
                        <?php } ?>
                        <div class="cart"><a onclick="addToCart('<?php echo $prodRelated['product_id']; ?>');" class="add_to_cart_small" title="<?php echo $button_cart; ?>"><?php echo $button_cart; ?></a>
                        <a class="add_to_wishlist_small" onclick="addToWishList('<?php echo $prodRelated['product_id']; ?>');" title="<?php echo $text_wish; ?>"><?php echo $text_wish; ?></a> <a class="add_to_compare_small" onclick="addToCompare('<?php echo $prodRelated['product_id']; ?>');" title="<?php echo $text_compare; ?>"><?php echo $text_compare; ?></a></div>
                     </div>
                  <?php } ?>
                  </div>
               </div>
