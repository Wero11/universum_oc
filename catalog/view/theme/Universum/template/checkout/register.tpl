...
$custom_captcha_text = $this->language->get('custom_captcha_text');
$custom_captcha_error = $this->language->get('custom_captcha_error');
?>
<div class="left">
...
<?php if ($text_agree) { ?>
<div class="buttons">
<div style="float: left"><?php echo $custom_captcha_text; ?><br />
					<input type="text" name="captcha" value="" autocomplete="off" style="width: 142px" /><br /><br />
					<img id="arc-captcha-image" src="index.php?route=information/contact/captcha" alt="" />
				</div>
