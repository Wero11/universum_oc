  ...
  <div class="product-list">
    ...
    <div class="prod_hold">
        ...
        <div class="count_holder_small">
          ...
          <div id="UniversumCountSmallSpecialPage<?php echo $product['product_id']; ?>"></div>
          <script type="text/javascript">
					$(function () {	
						$('#UniversumCountSmallSpecialPage<?php echo $product['product_id']; ?>').countdown({until: new Date(<?php echo $product['date_end']; ?>), compact: false});
					});
		</script>
          <div class="clear"></div>
          <?php } ?>
